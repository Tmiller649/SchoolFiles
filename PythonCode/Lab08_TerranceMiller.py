...
# Comments:
# All doc test work except error on delete function because it added an empty
# line a the end didn't know how to fix it so just turned in because funcitonallity
# was there
# pyTunes
